...
<head>
  ...
  <title>Serumpun Niaga | Update Orders</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../../../profile/index.php" class="nav-link">Contact</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Orders Status</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Update Status Link (active page) -->
           <li class="nav-item">
            <a href="../../pages/examples/projects.php" class="nav-link active">
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              <tbody>
                <?php
                $sql = "SELECT o.order_id, o.customer_id, o.printing_id, o.file_id, o.order_status, DATE_FORMAT(o.order_date, '%d-%m-%Y %H:%i:%s') AS order_date,
                c.customer_name, f.file_name, s.service_name AS print_type
                FROM orders o
                JOIN customer c ON o.customer_id = c.customer_id
                JOIN printing_details pd ON o.printing_id = pd.printing_id
                JOIN services s ON pd.print_type_id = s.service_id
                  ...
                  while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                      ...
                      <td class='project-actions text-right'>
                        <a class='btn btn-info btn-sm update-btn' data-id='{$row['order_id']}' href='#'>
