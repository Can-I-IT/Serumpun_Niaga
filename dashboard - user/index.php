...
$result = mysqli_query($conn, "SELECT customer_name, customer_email FROM customer WHERE customer_id = $customer_id");
...
// Total Orders
$customer_id = $_SESSION['customer_id'];
$result_orders = mysqli_query($conn, "SELECT COUNT(*) AS total_orders FROM orders WHERE customer_id = $customer_id");
$total_orders = mysqli_fetch_assoc($result_orders)['total_orders'];

// Pending Orders
$customer_id = $_SESSION['customer_id'];
$result_pending = mysqli_query($conn, "SELECT COUNT(*) AS pending_orders FROM orders WHERE order_status='Pending' AND customer_id = $customer_id");
$pending_orders = mysqli_fetch_assoc($result_pending)['pending_orders'];

// Completed Orders
$customer_id = $_SESSION['customer_id'];
$result_completed = mysqli_query($conn, "SELECT COUNT(*) AS completed_orders FROM orders WHERE order_status='Completed' AND customer_id = $customer_id");
$completed_orders = mysqli_fetch_assoc($result_completed)['completed_orders'];

// Total Files Uploaded
$result_files = mysqli_query($conn, "SELECT COUNT(*) AS total_files FROM file");
$total_files = mysqli_fetch_assoc($result_files)['total_files'];
?>
...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>Serumpun Niaga | User Dashboard</title>
  ...
  <body>
    ...
    <aside class="sidebar-nav-wrapper">
      ...
      <nav class="sidebar-nav">
        <ul>
          <li class="nav-item">
            <a href="#"><span class="icon"><i class="lni lni-dashboard"></i></span><span class="text">Dashboard</span></a>
          </li>
          <li class="nav-item">
            <a href="#place-order-form"><span class="icon"><i class="lni lni-upload"></i></span><span class="text">Make Order</span></a>
          </li>
          <li class="nav-item">
            <a href="../view orders/index.php"><span class="icon"><i class="lni lni-checkmark-circle"></i></span><span class="text">Order Status</span></a>
          </li>
          <li class="nav-item">
            <a href="../profile/index.php"><span class="icon"><i class="lni lni-user"></i></span><span class="text">My Profile</span></a>
          </li>
          <li class="nav-item">
            <a href="../logout/logout.php"><span class="icon"><i class="lni lni-exit"></i></span><span class="text">Logout</span></a>
          </li>
          <!--
                  ...
                  >
                    <div class="profile-info">
                      <div class="info">
                        ...
                        <div>
                          <h6 class="fw-500"><?php echo htmlspecialchars($user['customer_name']); ?></h6>
                          <p>User</p>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <li>
                      <div class="author-info flex items-center !p-1">
                        ...
                        <div class="content">
                          <h4 class="text-sm"><?php echo htmlspecialchars($user['customer_name']); ?></h4>
                          <a
                            class="text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white text-xs"
                            href="#"
                            ><?php echo htmlspecialchars($user['customer_email']); ?></a
                          >
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                    -->
                      <a href="../logout/logout.php"> <i class="lni lni-exit"></i> Sign Out </a>
                    </li>
                  </ul>
                </div>
                <!-- profile end -->
      ...
      <section class="section">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  <h6 class="mb-10">Total Orders Placed</h6>
                  <h3 class="text-bold mb-10"><?php echo $total_orders; ?></h3>
                  <!--
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  ...
                  <h3 class="text-bold mb-10"><?php echo $pending_orders; ?></h3>
                  <!--
                  <p class="text-sm text-success">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  ...
                  <h3 class="text-bold mb-10"><?php echo $completed_orders; ?></h3>
                  <!--
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  <h6 class="mb-10">Files Uploaded</h6>
                  <h3 class="text-bold mb-10"><?php echo $total_files; ?></h3>
                  <!--
                  <p class="text-sm text-danger">
            ...
            <div class="col-lg-7">
              <div class="card-style mb-30">
                <div class="title d-flex flex-wrap justify-content-between">
                  <div class="left">
                    <h6 class="text-medium mb-10">Total Orders Placed</h6>
                ...
                <div class="chart">
                  <canvas
                    id="Chart1"
                    style="width: 100%; height: 400px; margin-left: -35px"
                  ></canvas>
                </div>
                <!- End Chart ->
              </div>
          ...
          -->
            ...
            <div class="col-lg-5">
              <div class="card-style mb-30">
                ...
                >
                  <div class="left">
                    <h6 class="text-medium mb-30">Orders In Progress</h6>
                  </div>
                  <div class="right">
                    <div class="select-style-1">
                      <div class="select-position select-sm">
                ...
                <div class="chart">
                  <canvas
                    id="Chart2"
                    style="width: 100%; height: 400px; margin-left: -45px"
                  ></canvas>
                </div>
                <!- End Chart ->
              </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-7">
              <div class="card-style mb-30">
                ...
                >
                  <div class="left">
                    <h6 class="text-medium mb-2">Completed Orders</h6>
                  </div>
                  <div class="right">
                ...
                <div class="chart">
                  ...
                  <canvas
                    id="Chart3"
                    style="width: 100%; height: 450px; margin-left: -35px"
                  ></canvas>
                </div>
              </div>
            </div>
          -->
            ...
            <div class="col-lg-5">
              <div class="card-style mb-30">
                ...
                >
                  <div class="left">
                    <h6 class="text-medium mb-2">Files Uploaded</h6>
                  </div>
                  <div class="right">
                    <div class="select-style-1 mb-2">
                      <div class="select-position select-sm">
                ...
                <div class="chart">
                  <div id="legend4">
                    <ul
                      class="legend3 d-flex flex-wrap gap-3 gap-sm-0 align-items-center mb-30"
                    >
                      <li>
                        <div class="d-flex">
                          <span class="bg-color primary-bg"> </span>
                  ...
                  <canvas
                    id="Chart4"
                    style="width: 100%; height: 420px; margin-left: -35px"
                  ></canvas>
                </div>
                <!- End Chart ->
              </div>
          ...
          <div class="row">
            ...
            <?php
            $service_query = "SELECT service_name, service_category, service_price FROM services ORDER BY service_category, service_name";
            $service_result = mysqli_query($conn, $service_query);
            $current_category = "";
            ?>
            
            <div class="card-style mb-30">
              <h6 class="text-medium mb-3">Available Services & Prices</h6>
              <div class="table-responsive">
                <table class="table text-sm">
                  <thead>
                    <tr><th>Category</th><th>Service Name</th><th>Price (RM)</th></tr>
                  </thead>
                  <tbody>
                    <?php while ($s = mysqli_fetch_assoc($service_result)) { ?>
                      <tr>
                        ...
                        <td><?php echo number_format($s['service_price'], 2); ?></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
            ...
            <div class="card-style mb-30" id="place-order-form">
              <h6 class="text-medium mb-3">Place Your Order</h6>
              <form method="POST" action="../place order/place_order.php" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <label>Paper Size</label>
                    <select name="paper_size" class="form-control" required>
                      <?php
                      $papers = mysqli_query($conn, "SELECT * FROM services WHERE service_category = 'Paper Size'");
                      while ($p = mysqli_fetch_assoc($papers)) {
                        echo "<option value='{$p['service_id']}'>{$p['service_name']}</option>";
                      }
                      ?>
                      </select>
                    </div>
                    <div class="col-md-6 mb-3">
                      ...
                      <select name="print_type" class="form-control" required>
                        <?php
                        $prints = mysqli_query($conn, "SELECT * FROM services WHERE service_category = 'Print Type'");
                        while ($pt = mysqli_fetch_assoc($prints)) {
                          echo "<option value='{$pt['service_id']}'>{$pt['service_name']}</option>";
                        }
                        ?>
                        </select>
                      </div>
                      <div class="col-md-6 mb-3">
                        ...
                        <select name="binding" class="form-control" required>
                          <?php
                          $bindings = mysqli_query($conn, "SELECT * FROM services WHERE service_category = 'Binding'");
                          while ($b = mysqli_fetch_assoc($bindings)) {
                            echo "<option value='{$b['service_id']}'>{$b['service_name']}</option>";
                          }
                          ?>
                        </select>
                      </div>
                      <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="file" class="form-control" min="1" required>
                      </div>
                ...
                <div class="table-responsive">
                  <table class="table top-selling-table">
                    <thead>
                      <tr>
                        <th>
                          <h6 class="text-sm text-medium">File Name</h6>
                        </th>
                        <th class="min-width">
                          <h6 class="text-sm text-medium">Print Type</h6>
                        </th>
                        <!--
                        <th class="min-width">
                        ...
                        -->
                        <th class="min-width">
                          <h6 class="text-sm text-medium">Paper Size</h6>
                        </th>
                        <th>
                          <h6 class="text-sm text-medium">Binding</h6>
                        </th>
                        <th>
                          <h6 class="text-sm text-medium">Status</h6>
                        </th>
                        <th>
                          <h6 class="text-sm text-medium">Download</h6>
                        </th>
                        <th>
                    ...
                    <tbody>
                      ...
                      $query = "
                      SELECT 
                        f.file_name AS saved_name,
                        f.file_original_name AS original_name, 
                        pt.service_name AS print_type, 
                        pt.service_price AS pt_price,
                        ps.service_name AS paper_size,
                        ps.service_price AS ps_price,
                        b.service_name AS binding,
                        b.service_price AS b_price,
                        pd.number_of_copies,
                        o.order_status
                      FROM orders o
                      JOIN file f ON o.file_id = f.file_id
                      JOIN printing_details pd ON o.printing_id = pd.printing_id
                      JOIN services pt ON pd.print_type_id = pt.service_id
                      JOIN services ps ON pd.paper_size_id = ps.service_id
                      JOIN services b ON pd.binding_id = b.service_id
                      WHERE o.customer_id = $customer_id
                      ORDER BY f.file_id DESC 
                      LIMIT 10
                      ";
                      $result_history = mysqli_query($conn, $query);
                      while ($row = mysqli_fetch_assoc($result_history)) {
                        $total_price = ($row['pt_price'] + $row['ps_price'] + $row['b_price']) * $row['number_of_copies'];
                      ?>
                      <tr>
                        <td>
                          <div class="product">
                          ...
                          -->
                            <p class="text-sm"><?php echo htmlspecialchars($row['original_name']); ?></p>
                          </div>
                        </td>
                        <td><p class="text-sm"><?php echo htmlspecialchars($row['print_type']); ?></p></td>
                        <td><p class="text-sm"><?php echo htmlspecialchars($row['paper_size']); ?></p></td>
                        <td><p class="text-sm"><?php echo htmlspecialchars($row['binding']); ?></p></td>
                        <td>
                          <span class="status-btn <?php
                          switch (strtolower($row['order_status'])) {
                            case 'pending': echo 'close-btn'; break;
                            case 'completed': echo 'success-btn'; break;
                            case 'refund': echo 'warning-btn'; break;
                            case 'canceled': echo 'close-btn'; break;
                        ...
                        <td>
                          <a href="../place order/file_uploads/<?php echo urlencode($row['saved_name']); ?>" download>
                            Download
                          </a>
                        </td>
                        <td>
                          <span class="text-sm">Total: RM <?php echo number_format($total_price, 2); ?></span>
                        </td>
                      </tr>
          ...
          <div class="row">
            <div class="col-md-6 order-last order-md-first">
              <div class="copyright text-center text-md-start">
                <p class="text-sm">
                  Online Print System - Serumpun Niaga Enterprise
                  <!--
